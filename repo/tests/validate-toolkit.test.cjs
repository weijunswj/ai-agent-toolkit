...
test('internal AI-facing surfaces are generated from declared project output', () => {
  ...
  const expectedMarkdown = [
    ...
    ['n8n.local-setup', 'skills/n8n-local-setup/references/ai-agent-platforms/codex.md', 'curated_output_for_ai/references/ai-agent-platforms/codex.md'],
    ['n8n.local-setup', 'skills/n8n-local-setup/references/ai-agent-platforms/claude-code.md', 'curated_output_for_ai/references/ai-agent-platforms/claude-code.md'],
    ['n8n.local-setup', 'skills/n8n-local-setup/references/ai-agent-platforms/opencode.md', 'curated_output_for_ai/references/ai-agent-platforms/opencode.md'],
    ['n8n.local-setup', 'skills/n8n-local-setup/references/ai-agent-platforms/antigravity.md', 'curated_output_for_ai/references/ai-agent-platforms/antigravity.md'],
