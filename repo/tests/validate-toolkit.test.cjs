...
test('internal AI-facing surfaces are generated from declared project output', () => {
  ...
  const expectedExactCopies = [
    ...
    ['n8n.local-setup', 'skills/n8n-local-setup/templates/mcp-configs/antigravity-mcp-config.md', '_main/antigravity-mcp-config.md'],
    ['n8n.local-setup', 'skills/n8n-local-setup/templates/mcp-configs/claude-mcp-config.md', '_main/claude-mcp-config.md'],
    ['n8n.local-setup', 'skills/n8n-local-setup/templates/mcp-configs/codex-mcp-config.md', '_main/codex-mcp-config.md'],
    ['n8n.local-setup', 'skills/n8n-local-setup/templates/mcp-configs/opencode-mcp-config.md', '_main/opencode-mcp-config.md'],
