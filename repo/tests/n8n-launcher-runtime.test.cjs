...
const launcherCases = [
  {
    ...
    menu: 'skills/n8n-environment-setup/templates/.n8n-local/scripts/n8n-local-menu.ps1',
  ...
  },
  {
    ...
    menu: 'skills/n8n-environment-setup/templates/.n8n-production-cloudflare/scripts/n8n-production-cloudflare-menu.ps1',
