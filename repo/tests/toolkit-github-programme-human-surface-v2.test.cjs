...
const ROOT = 'S2-PRE-E4-HUMAN-SURFACE-PHASE-TRUTH-004';
const LOCK = 'DL-S2-PRE-E4-HUMAN-SURFACE-PHASE-TRUTH-004';
...
function descriptor(overrides = {}) {
  return {
    ...
    summary: 'Implement the four-operation humanSurfaceV2 facade for Root-004.',
...
test('Root-004 keeps every descriptor free-text field historical and binds only the complete phase projection', () => {
  const inputDescriptor = descriptor({
