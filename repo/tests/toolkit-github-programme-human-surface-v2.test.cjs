...
const ROOT = 'S2-PRE-E4-HUMAN-SURFACE-SCHEMA-CONSISTENCY-006';
const LOCK = 'DL-S2-PRE-E4-HUMAN-SURFACE-SCHEMA-CONSISTENCY-006';
...
function descriptor(overrides = {}) {
  return {
    ...
    summary: 'Implement the four-operation humanSurfaceV2 facade for Root-006.',
