...
const ROOT = 'S2-PRE-E4-HUMAN-SURFACE-LEGACY-READ-COMPATIBILITY-007';
const LOCK = 'DL-S2-PRE-E4-HUMAN-SURFACE-LEGACY-READ-COMPATIBILITY-007';
...
function descriptor(overrides = {}) {
  return {
    ...
    summary: 'Preserve frozen-v5 child readComplete compatibility for Root-007.',
