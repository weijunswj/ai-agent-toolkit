...
const DOCKER_WINDOWS_INSTALL_URL = 'https://docs.docker.com/desktop/setup/install/windows-install/';


const configs = [
  {
    id: 'local',
    script: 'skills/n8n-environment-setup/templates/.n8n-local/scripts/n8n-local-menu.ps1',
    wrapper: 'skills/n8n-environment-setup/templates/.n8n-local/_n8n-local.cmd',
  ...
  },
  {
    ...
    script: 'skills/n8n-environment-setup/templates/.n8n-production-cloudflare/scripts/n8n-production-cloudflare-menu.ps1',
    wrapper: 'skills/n8n-environment-setup/templates/.n8n-production-cloudflare/_n8n-production-cloudflare.cmd',
...
function Write-DockerManualInstallPage {
  ...
  Write-Host '${DOCKER_WINDOWS_INSTALL_URL}' -ForegroundColor White
