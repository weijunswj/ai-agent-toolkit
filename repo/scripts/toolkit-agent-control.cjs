...
function inspectResources(options = {}) {
  if (Object.prototype.hasOwnProperty.call(options, 'resourceState')) {
    if (!options.resourceState || typeof options.resourceState !== 'object' || Array.isArray(options.resourceState)) return null;
    return { source: options.resourceState.source || 'fixture', ...options.resourceState };
  }
