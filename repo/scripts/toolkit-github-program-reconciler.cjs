...
module.exports = Object.freeze({
  ...
  V5_RECOVERY_STATUSES: convergenceV5.RECOVERY_STATUSES, V5_RECEIPT_TYPES: convergenceV5.RECEIPT_TYPES, V5_GATE_STATES: convergenceV5.GATE_STATES, V5_PROGRAMME_STATES: convergenceV5.PROGRAMME_STATES,
  ...
  validateReceiptConsumption: convergenceV5.validateReceiptConsumption, receiptInventoryDigest: convergenceV5.receiptInventoryDigest, validateProgrammeOperations: convergenceV5.validateProgrammeOperations,
