...
function createRuntime(options = {}) {
  ...
  return Object.freeze({
    ...
    programmeV5: Object.freeze({
      ...
      HUMAN_V2_VERSION: programmeV5.HUMAN_V2_VERSION,
      HUMAN_V2_MARKERS: programmeV5.HUMAN_V2_MARKERS,
      HUMAN_V2_TOOLKIT_MARKERS: programmeV5.HUMAN_V2_TOOLKIT_MARKERS,
      PublicSurfaceCodec: programmeV5.PublicSurfaceCodec,
      renderHumanV2Parent: programmeV5.renderHumanV2Parent,
      renderHumanV2Child: programmeV5.renderHumanV2Child,
      renderHumanV2Pr: programmeV5.renderHumanV2Pr,
      parseHumanV2Parent: programmeV5.parseHumanV2Parent,
      parseHumanV2Child: programmeV5.parseHumanV2Child,
      verifyHumanV2Child: programmeV5.verifyHumanV2Child,
      verifyHumanV2Pr: programmeV5.verifyHumanV2Pr,
      parseProgrammeBodyComplete: programmeV5.parseProgrammeBodyComplete,
      selectChildIssue: programmeV5.selectChildIssue,
      validateHumanCanonicalState: programmeV5.validateHumanCanonicalState,
      validateHumanSurfaceConformanceDecision: programmeV5.validateHumanSurfaceConformanceDecision,
      createHumanSurfaceConformanceDecision: programmeV5.createHumanSurfaceConformanceDecision,
      prepareHumanSurfaceConformanceDecision: programmeV5.prepareHumanSurfaceConformanceDecision,
      validateHumanSurfaceConformanceEvidence: programmeV5.validateHumanSurfaceConformanceEvidence,
      createHumanSurfaceConformanceEvidence: programmeV5.createHumanSurfaceConformanceEvidence,
      buildHumanSurfaceConformanceEvidence: programmeV5.buildHumanSurfaceConformanceEvidence,
      deriveHumanSurfaceHistoryTarget: programmeV5.deriveHumanSurfaceHistoryTarget,
      validateHistoryOnlyDelta: programmeV5.validateHistoryOnlyDelta,
      humanHistoryImmutableDigest: programmeV5.humanHistoryImmutableDigest,
      classifyHumanV2MigrationState: programmeV5.classifyHumanV2MigrationState,
      prepareHumanV2Migration: programmeV5.prepareHumanV2Migration,
      recoverHumanV2Migration: programmeV5.recoverHumanV2Migration,
    }),
  });
}
