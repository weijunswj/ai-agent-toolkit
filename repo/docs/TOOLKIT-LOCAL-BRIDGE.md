...
- The bridge never signals the recorded owner for real, and lock creation uses an exclusive write so a lock re-created by another process between recovery and acquisition is not clobbered.
