...
Use [for_ai/tools/design-system-generator/](../tools/design-system-generator/) for local-only CSV-backed design-system recommendations. It does not require internet access and is separate from the instruction-only [design skill](../skills/design/ui-ux-secure-frontend-design/).
