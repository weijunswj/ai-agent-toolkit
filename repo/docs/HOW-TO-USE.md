...
- [n8n local setup](../../skills/n8n-local-setup/references/n8n/local-setup.md) contains the local guide. For Hostinger VPS and Coolify setup/maintenance, use `codex-ssh-hostinger-coolify-setup-maintainer`.
