...
- If eligible source/routing/contract edits are mixed with forbidden workflow, maintenance-script, or preserved-source path changes, the workflow fails instead of pushing.
