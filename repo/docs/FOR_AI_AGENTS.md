...
| `repository-security-gate` | Content-derived repository security classification, pinned scanner gates, provenance/suppression validation, sanitised evidence, and exact-head review packets. |
