...
| `context-preserving-ai-publisher` | Creating or maintaining source-traceable AI-facing repo surfaces, contracts, provenance, templates, audits, or anti-drift docs. |
...
| `github-governance-review-reconciler` | Explicit-only current-main N5 governance of one GitHub parent/direct-child queue, deterministic bounded reconciliation, truthful PR-review inventory and disposition evidence, and parent-managed Deferred Findings; never review mutation, Ready, merge, or Web finality. |
