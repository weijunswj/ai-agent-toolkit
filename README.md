...
| Claude Code | <strong>Choose one:</strong><ul><li>`<repo>/.claude/skills/<skill-name>/`</li><li>`$HOME/.claude/skills/<skill-name>/`</li></ul> | 1) Create or merge `AGENTS.md` first from [`repo-local/AGENTS.managed.template.md`](skills/ai-coding-agent-rules/repo-local/AGENTS.managed.template.md).<br>2) Add `CLAUDE.md` from [`repo-local/CLAUDE.shim.template.md`](skills/ai-coding-agent-rules/repo-local/CLAUDE.shim.template.md). | <strong>Resources:</strong><ul><li>[Claude Code reference](skills/n8n-local-setup/references/ai-agent-platforms/claude-code.md)</li><li>[Claude Code MCP config](skills/n8n-local-setup/templates/mcp-configs/claude-mcp-config.md)</li></ul> |
...
| Gemini CLI | <strong>Use Gemini extension layout:</strong><ul><li>`$HOME/.gemini/extensions/ai-agent-toolkit/gemini-extension.json`</li><li>`$HOME/.gemini/extensions/ai-agent-toolkit/skills/<skill-name>/SKILL.md`</li></ul> | 1) Create or merge `AGENTS.md` first from [`repo-local/AGENTS.managed.template.md`](skills/ai-coding-agent-rules/repo-local/AGENTS.managed.template.md).<br>2) Add `GEMINI.md` from [`repo-local/GEMINI.shim.template.md`](skills/ai-coding-agent-rules/repo-local/GEMINI.shim.template.md). | N/A |
| Antigravity | `$HOME/.gemini/config/plugins/ai-agent-toolkit/skills/<skill-name>/` | 1) Create or merge `AGENTS.md` first from [`repo-local/AGENTS.managed.template.md`](skills/ai-coding-agent-rules/repo-local/AGENTS.managed.template.md).<br>2) Add `GEMINI.md` from [`repo-local/GEMINI.shim.template.md`](skills/ai-coding-agent-rules/repo-local/GEMINI.shim.template.md) if using the Gemini shim.<br>3) Add `.agents/rules/00-agent-toolkit-bootstrap.md` from [`repo-local/antigravity-bootstrap.template.md`](skills/ai-coding-agent-rules/repo-local/antigravity-bootstrap.template.md). | <strong>Resources:</strong><ul><li>[Antigravity reference](skills/n8n-local-setup/references/ai-agent-platforms/antigravity.md)</li><li>[Antigravity MCP config](skills/n8n-local-setup/templates/mcp-configs/antigravity-mcp-config.md)</li></ul> |
