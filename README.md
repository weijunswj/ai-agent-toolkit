...
| [GitHub Program Reconciler](skills/github-program-reconciler/) | Explicit-only current-main programme governance, bounded reconciliation, truthful exact-head review evidence, and Deferred Findings without review mutation or Web finality. |
