...
| Gemini CLI | Supported Gemini CLI skill or extension location | 1) Create or merge `AGENTS.md` first from [`repo-local/AGENTS.managed.template.md`](skills/ai-coding-agent-rules/repo-local/AGENTS.managed.template.md).<br>2) Add `GEMINI.md` from [`repo-local/GEMINI.shim.template.md`](skills/ai-coding-agent-rules/repo-local/GEMINI.shim.template.md). | Gemini CLI can share the same root `AGENTS.md` pattern as other agents. |
| Antigravity | `$HOME/.gemini/config/plugins/ai-agent-toolkit/skills/<skill-name>/` | 1) Create or merge `AGENTS.md` first from [`repo-local/AGENTS.managed.template.md`](skills/ai-coding-agent-rules/repo-local/AGENTS.managed.template.md).<br>2) Add `GEMINI.md` from [`repo-local/GEMINI.shim.template.md`](skills/ai-coding-agent-rules/repo-local/GEMINI.shim.template.md) if using the Gemini shim.<br>3) Add `.agents/rules/00-agent-toolkit-bootstrap.md` from [`repo-local/antigravity-bootstrap.template.md`](skills/ai-coding-agent-rules/repo-local/antigravity-bootstrap.template.md) if using the Antigravity bootstrap. | <strong>Resources:</strong><ul><li>[Antigravity reference](skills/n8n-local-setup/references/ai-agent-platforms/antigravity.md)</li><li>[Antigravity MCP config](skills/n8n-local-setup/templates/mcp-configs/antigravity-mcp-config.md)</li></ul> |
