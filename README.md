...
| [Repository Security Gate](_projects/cicd/repository-security-gate/) | Repository-owned classification, pinned scanners, provenance locks, static rules, reports, suppressions, and review packets. | [_main/](_projects/cicd/repository-security-gate/_main/) |
...
| [Repository Security Gate](skills/repository-security-gate/) | Run a content-derived, fail-closed repository security gate with pinned tools and sanitised exact-head evidence. |
