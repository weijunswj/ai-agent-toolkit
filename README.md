...
| Gemini CLI | <strong>Use Gemini extension layout:</strong><ul><li>`$HOME/.gemini/extensions/ai-agent-toolkit/gemini-extension.json`</li><li>`$HOME/.gemini/extensions/ai-agent-toolkit/skills/<skill-name>/SKILL.md`</li></ul> | <ol><li>Create or merge `AGENTS.md` first from [`repo-local/AGENTS.managed.template.md`](skills/ai-coding-agent-rules/repo-local/AGENTS.managed.template.md).</li><li>Add `GEMINI.md` from [`repo-local/GEMINI.shim.template.md`](skills/ai-coding-agent-rules/repo-local/GEMINI.shim.template.md).</li></ol> | N/A |
