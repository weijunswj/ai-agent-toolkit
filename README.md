...
- If a PR mixes eligible source/routing/contract edits with forbidden workflow, maintenance-script, or preserved-source paths, auto-sync must fail instead of pushing.
