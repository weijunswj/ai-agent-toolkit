...
| [Managed App Foundation Review](_projects/development/managed-app-foundation-review/) | Build-vs-buy planning for low-cost managed auth, database, CRM, forms, email, storage, analytics, and account-security foundations. | [_main/](_projects/development/managed-app-foundation-review/_main/) |
...
| [Managed App Foundation Review](skills/managed-app-foundation-review/) | Compare low-cost managed foundations before custom-building auth, database, CRM, forms, email, analytics, and account-security surfaces. |
