...
| [Repository Loop Core](_projects/development/repo-loop-core/) | Source-only A1 contracts for authority evidence, bounded non-Web assignments, trusted operation time, canonical Git paths, immutable terminal packets, and typed default-off refusal. | [_main/](_projects/development/repo-loop-core/_main/) |
