...
| Guide | Setup or workflow documentation under `guides/` or `docs/`. |
| Template | Copy-safe source material under `templates/`. |
| Pack | Approval-gated bundle manifest under `packs/`. |
| Registry | JSON discovery metadata under `registry/`. |
