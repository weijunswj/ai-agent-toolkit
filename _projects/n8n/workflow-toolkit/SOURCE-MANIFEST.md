...
- `skills/n8n-workflow-helper-scripts/agents/openai.yaml` and `skills/n8n-workflow-templates/agents/openai.yaml` are generated from reviewed curated OpenAI invocation-policy metadata.
