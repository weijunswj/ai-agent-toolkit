...
| Guide | Use when |
| --- | --- |
| [local-setup.md](local-setup.md) | Running the Docker Compose Fast Path with n8n, Postgres, ngrok, and Codex MCP. |
...
| [docker-compose-ngrok.md](docker-compose-ngrok.md) | Understanding the Docker Compose stack and local stack templates. |
