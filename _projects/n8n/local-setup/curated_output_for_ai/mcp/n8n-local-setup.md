...
- Guided local stack launcher: [skills/n8n-local-setup/templates/local-stack/_n8n-local.cmd](../../skills/n8n-local-setup/templates/local-stack/_n8n-local.cmd)
...
- Read declared `_main` recipe sources and AI-facing consumer surfaces.
...
- `.env*`, credentials, private keys, `.n8n-local/**`, `.tmp/**`, live n8n exports/imports, package artifacts, user home paths, and system paths.
