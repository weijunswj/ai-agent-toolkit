...
- [Local stack templates](../../templates/local-stack/), Codex official n8n Skills plus MCP setup references, and the local/Hostinger Coolify n8n guides.
...
- Codex official n8n Skills plus MCP setup is secondary and not part of the beginner local path.
