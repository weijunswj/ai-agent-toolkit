...
- Platform overview/index files that do not have preserved full source guides are generated from `curated_output_for_ai/references/`.
...
- `skills/n8n-local-setup/templates/agent-rules/AGENTS.md`, `CLAUDE.md`, and `GEMINI.md` are generated by concat recipes from `_main/templates/partials/*.md` plus the linked toolkit partial.
