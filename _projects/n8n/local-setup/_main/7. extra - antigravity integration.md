...
- Install or copy generic AI coding agent rules from [GEMINI.template.md](../../../development/ai-coding-agent-rules/_main/GEMINI.template.md), then copy or merge them into the target repo root as `GEMINI.md`.
