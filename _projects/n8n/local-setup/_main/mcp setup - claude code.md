...
The primary local setup guide is [1. Local Setup](./_Page%201.%20Local%20Setup.md). This page is a secondary Claude Code reference, not a required local setup path.
