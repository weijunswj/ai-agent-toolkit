...
Start with Local Setup for Docker Desktop on your own computer. Use Page 2 when Coolify already exists on a Hostinger VPS and you want to deploy n8n inside Coolify. For Hostinger VPS plus Coolify setup or server maintenance, use [`codex-ssh-hostinger-coolify-setup-maintainer`](../../development/hostinger-coolify-production-guide/) first, then return to Page 2 for n8n-specific deployment guidance.
