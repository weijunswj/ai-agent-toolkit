...
For always-on public hosting, use [3. VPS Hosting](./3.%20vps%20hosting.md). VPS and Hostinger hosting are separate from this local Docker Desktop setup.
...
- Keep VPS/Hostinger setup separate in [3. VPS Hosting](./3.%20vps%20hosting.md).
