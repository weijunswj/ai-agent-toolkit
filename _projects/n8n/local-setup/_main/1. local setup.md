...
For always-on public hosting, keep using [4. VPS Hosting](./4.%20vps%20hosting.md). VPS and Hostinger hosting are separate from this local Docker Desktop setup.
...
```powershell
Copy-Item -LiteralPath "_projects\n8n\local-setup\_main\templates\local-stack\docker-compose.yml" -Destination "$env:USERPROFILE\Desktop\n8n-local\docker-compose.yml" -Force
Copy-Item -LiteralPath "_projects\n8n\local-setup\_main\templates\local-stack\.env.example" -Destination "$env:USERPROFILE\Desktop\n8n-local\.env.example" -Force
Copy-Item -LiteralPath "_projects\n8n\local-setup\_main\templates\local-stack\n8n-local.cmd" -Destination "$env:USERPROFILE\Desktop\n8n-local\n8n-local.cmd" -Force
Copy-Item -LiteralPath "_projects\n8n\local-setup\_main\templates\local-stack\scripts" -Destination "$env:USERPROFILE\Desktop\n8n-local\" -Recurse -Force
```
...
Use the [Codex MCP config](./templates/codex-mcp-config.md).
...
- [AGENTS.template.md](../../../development/ai-coding-agent-rules/_main/AGENTS.template.md) for Codex or OpenCode.
- [CLAUDE.template.md](../../../development/ai-coding-agent-rules/_main/CLAUDE.template.md) for Claude Code.
- [GEMINI.template.md](../../../development/ai-coding-agent-rules/_main/GEMINI.template.md) for Gemini or Antigravity.
...
The local setup project references the n8n rules; it does not own them. Use the published [n8n Agent Rules](../../../../skills/n8n-agent-rules/) skill for the full operating contract.
...
- [AGENTS.template.md](../../../development/ai-coding-agent-rules/_main/AGENTS.template.md)
...
- [CLAUDE.template.md](../../../development/ai-coding-agent-rules/_main/CLAUDE.template.md)
- [n8n Agent Rules](../../../../skills/n8n-agent-rules/)
- [Claude MCP config](./templates/claude-mcp-config.md)
- [Claude Code Integration appendix](./5.%20extra%20-%20claude%20code%20integration.md)
...
- [OpenCode Integration appendix](./6.%20extra%20-%20opencode%20integration.md)
...
- [GEMINI.template.md](../../../development/ai-coding-agent-rules/_main/GEMINI.template.md)
- [n8n Agent Rules](../../../../skills/n8n-agent-rules/)
- [Antigravity MCP config](./templates/antigravity-mcp-config.md)
- [Antigravity Integration appendix](./7.%20extra%20-%20antigravity%20integration.md)
...
- [2. Upgrading](./2.%20upgrading.md) for focused local, VPS, and npm update notes.
- [3. Tunneling Guide](./3.%20tunneling%20guide.md) for focused ngrok tunnel behavior.
- [3a. Docker Compose + ngrok](./3a.%20docker%20compose%20%2B%20ngrok.md) for template details.
- [4. VPS Hosting](./4.%20vps%20hosting.md) for Hostinger, VPS, Coolify, and production hosting.
- [5. Claude Code Integration](./5.%20extra%20-%20claude%20code%20integration.md) for Claude-specific setup detail.
- [6. OpenCode Integration](./6.%20extra%20-%20opencode%20integration.md) for OpenCode-specific setup detail.
- [7. Antigravity Integration](./7.%20extra%20-%20antigravity%20integration.md) for Antigravity-specific setup detail.
