# Source Manifest: Local AI Stack Safety
...
- `skills/local-ai-stack-safety/README.md` is generated from `_main/skill/README.md`.
- `skills/local-ai-stack-safety/SKILL.md` is generated from `_main/skill/SKILL.md`.
- `skills/local-ai-stack-safety/agents/openai.yaml` is generated from `_main/skill/agents/openai.yaml`.
