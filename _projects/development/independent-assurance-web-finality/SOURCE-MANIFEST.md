...
- assurance-web-finality-policy.json - the locked authority boundaries,
  decision rules, invalidation matrix, repair loop, G4A boundary, required
...
- repo/scripts/toolkit-assurance-web-finality.cjs - dependency-free pure
  ...
  bounded statuses. It has no provider, host, Web, GitHub, Ready,
...
- repo/tests/toolkit-assurance-web-finality.run169-red.test.cjs - the
  ...
  Ready/merge/readback, and privacy cases.
- repo/tests/toolkit-assurance-web-finality.run172-red.test.cjs - focused
  ...
  finality tuple binding, and truthful handoff reports.
...
Web transport, workflow files, Ready, merge, branch cleanup,
