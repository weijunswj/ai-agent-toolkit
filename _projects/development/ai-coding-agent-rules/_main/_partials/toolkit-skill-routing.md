...
| `strict-pr-review` | Reviewing a GitHub PR, branch, diff, proposed merge, merge readiness, or checking a PR properly with evidence, verification limits, and an explicit merge verdict. |
