...
- [AGENTS.template.md](AGENTS.template.md), [CLAUDE.template.md](CLAUDE.template.md), and [GEMINI.template.md](GEMINI.template.md) are generic baseline templates.
...
- [_partials/ai-coding-agent-execution.md](_partials/ai-coding-agent-execution.md) generates the generic baseline templates.
