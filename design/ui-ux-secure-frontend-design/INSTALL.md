...
Install the whole `ui-ux-secure-frontend-design/` folder, including `SKILL.md`, `agents/`, `examples/`, and `references/`.
...
```text
.agents/skills/ui-ux-secure-frontend-design/
```
...
```text
.claude/skills/ui-ux-secure-frontend-design/
```
...
If using a repository that stores reusable skills under `skills/`, copy the folder to:
