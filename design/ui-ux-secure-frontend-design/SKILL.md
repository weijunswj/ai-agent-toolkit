...
description: security-first frontend UI/UX design skill for creating, reviewing, and improving web interfaces. use for frontend design systems, landing pages, dashboards, SaaS pages, forms, component planning, accessibility, responsive polish, privacy-safe UX, and implementation review. instruction-only; no scripts, dependencies, network calls, or vendored upstream code.
---
