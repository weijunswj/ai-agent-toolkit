...
const { comparableWorkflow } = require('../templates/n8n/sync-helpers/should-import-n8n-workflow.cjs');
const { selectBindingsWithMeta, restoreLiveWebhookIds } = require('../templates/n8n/sync-helpers/prepare-n8n-live-import.cjs');

const scriptDir = path.resolve(__dirname, '..', 'templates', 'n8n', 'sync-helpers');
...
const sanitizerScript = path.resolve(__dirname, '..', 'templates', 'n8n', 'sanitizer', 'prepare-n8n-template.js');
const sanitizerPs1 = path.resolve(__dirname, '..', 'templates', 'n8n', 'sanitizer', 'sanitise-n8n-template.ps1');
