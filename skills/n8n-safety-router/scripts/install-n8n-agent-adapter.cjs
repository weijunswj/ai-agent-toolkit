...
function main() {
  ...
  if (!targets.length) {
    ...
    console.log('Required next step: Ask whether to install or repair repo-local AGENTS.md with repository-agent-rules, create/update only AGENTS.md with this adapter, or choose none.');
