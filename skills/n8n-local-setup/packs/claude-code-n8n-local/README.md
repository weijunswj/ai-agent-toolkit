...
- [Local stack templates](../../templates/local-stack/), Claude Code official n8n Skills plus MCP setup references, and the local/Hostinger Coolify n8n guides.
...
- Use official n8n Skills and n8n Agent Rules before workflow, import/export, credential, execution, repo/live sync, or live-instance work.
- Claude Code official n8n Skills plus MCP setup is secondary and not part of the beginner local path.
