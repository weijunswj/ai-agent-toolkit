...
For skill installation, prefer plugin/package install for Codex and Claude Code, plugin-scoped install for Antigravity, and a short manual skill-folder install for OpenCode. Copy whole skill folders, not just `SKILL.md`.
