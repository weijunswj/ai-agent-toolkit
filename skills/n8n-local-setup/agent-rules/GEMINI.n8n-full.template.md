...
-->
# GEMINI.n8n-full.template.md n8n AI coding agent rules with toolkit skill routing

Use this generated template for Gemini CLI or Antigravity for n8n work when this toolkit's skills folders are installed or copied.
...
Copy or merge the fenced payload into the target repo root as `GEMINI.md` only when the user explicitly wants generic Gemini CLI/Antigravity rules with toolkit skill routing and n8n MCP/workflow rules installed.
