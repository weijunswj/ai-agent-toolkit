...
Source: _projects/n8n/local-setup/_main/3. vps hosting.md
Update the project source and run sync.
-->
# 3. VPS Hosting for n8n
...
If you are only testing locally, stick to [1. Local Setup](./1.%20local%20setup.md).
...
## 3.2 Moving From Local ngrok To Hostinger
