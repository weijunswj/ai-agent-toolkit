...
The primary local setup guide is [1. Local Setup](./1.%20local%20setup.md). This page is retained as an appendix/reference for focused tunnel details, not as a separate start path.
