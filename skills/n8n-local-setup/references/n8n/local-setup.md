...
* Official n8n Skills plus instance-level MCP references are secondary. Do not start there.
...
* Official n8n Skills plus instance-level MCP references are available as secondary material, not as the beginner setup path.
...
Use this table only when you want an AI coding agent to work with n8n workflows through the official n8n Skills plus instance-level MCP setup:
