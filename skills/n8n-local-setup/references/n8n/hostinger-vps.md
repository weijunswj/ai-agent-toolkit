...
This is not the local Docker Desktop path. If you are testing on your own Windows computer, start with [Page 1 - Local Setup](local-setup.md).

This is not the local/CGNAT Cloudflare Tunnel production path. If you want to host production n8n publicly from a local machine through an outbound Cloudflare Tunnel connector, use [Page 3 - Production Self-Hosting With Cloudflare Tunnel](production-cloudflare-tunnel.md).
...
- [Page 3 - Production Self-Hosting With Cloudflare Tunnel](production-cloudflare-tunnel.md)
