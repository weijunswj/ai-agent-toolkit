...
Source: _projects/n8n/local-setup/_main/2. hostinger vps.md
...
This is not the local ngrok path. If you are only testing on your own computer, start with [1. Local Setup](local-setup.md).
