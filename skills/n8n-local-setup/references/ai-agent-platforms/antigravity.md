...
The primary local setup guide is [1. Local Setup](./1.%20local%20setup.md). This page is retained as a secondary platform reference for Antigravity details, not as a required local setup path.
