...
Source: _projects/n8n/local-setup/_main/mcp setup - opencode
Update the project source and run sync.
-->
# OpenCode MCP Setup

The primary local setup guide is [1. Local Setup](../n8n/local-setup.md). This page is a secondary OpenCode reference, not a required local setup path.
