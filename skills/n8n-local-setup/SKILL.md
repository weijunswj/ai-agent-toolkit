...
- Prefer plugin/package install for Codex and Claude Code, plugin-scoped install for Antigravity, and short manual skill-folder install notes for OpenCode. Keep whole skill folders together when copying.
