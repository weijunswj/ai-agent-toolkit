...
Canonical source material: skills/frontend-art-direction/
...
- `.agents/skills/frontend-art-direction/` when that is the trusted Codex-installed copy.
- `.claude/skills/frontend-art-direction/` when that is the trusted Claude project skill copy.
- `~/.claude/skills/frontend-art-direction/` when that is the trusted Claude personal skill copy.
