...
- Consider self-hosted n8n on Hostinger/Coolify for suitable internal workflow automation, while applying `n8n-safety-router` before any n8n workflow design, JSON, import/export, activation, execution, credentials, or live-instance work.
...
- Do not use this skill to bypass n8n safety rules. n8n workflow work still starts with `n8n-safety-router`, and live n8n actions require explicit current-turn approval.
