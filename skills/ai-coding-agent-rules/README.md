...
| Antigravity | 1) `AGENTS.md`<br>2) `GEMINI.md`<br>3) `.agents/rules/00-agent-toolkit-bootstrap.md` | 1) [repo-local/AGENTS.managed.template.md](repo-local/AGENTS.managed.template.md)<br>2) [repo-local/GEMINI.shim.template.md](repo-local/GEMINI.shim.template.md)<br>3) [repo-local/antigravity-bootstrap.template.md](repo-local/antigravity-bootstrap.template.md) |
