...
For n8n-specific workflow and MCP safety rules, install or load `skills/n8n-agent-rules`. Do not copy the full n8n rules into global always-on generic instructions unless you intentionally accept the context cost.
