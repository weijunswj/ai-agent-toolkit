...
Source: _projects/n8n/workflow-toolkit/curated_output_for_ai/skills/n8n-workflow-helper-scripts/SKILL.md
...
- Follow `n8n-agent-rules` for official n8n Skills, `using-n8n-skills`, workflow JSON, official n8n MCP, `n8n_live`, import/export, validation, credentials, webhook IDs, activation, execution, repo/live sync, and live n8n safety.
