...
Source: _projects/development/ai-coding-agent-rules/curated_output_for_ai/cross-skill-references/n8n-agent-rules-for-n8n-workflow-helper-scripts.md
...
- Generated destination: `skills/n8n-workflow-helper-scripts/references/n8n-agent-rules.md`
