...
Source: skills/n8n-agent-rules/README.md
-->
...
The installer writes the canonical managed block sourced from `repo/contracts/agent-rules/n8n-agent-rules-adapter.md`. It must not append separate n8n adapter variants to `CLAUDE.md` or `GEMINI.md`.
