...
n8n tasks include official n8n Skills, `using-n8n-skills`, workflow JSON, official n8n MCP, n8n_live, import/export, helper scripts, validation, credentials, webhook IDs, activation, execution, repo/live sync, and workflow templates.
