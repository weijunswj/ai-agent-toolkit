...
Source: _projects/development/ai-coding-agent-rules/curated_output_for_ai/adapters/CLAUDE.n8n-brief.template.md
...
n8n tasks include [official n8n Skills](https://github.com/n8n-io/skills), their entry-point meta-skill currently named `using-n8n-skills-official`, workflow JSON, official n8n MCP, n8n_live, import/export, helper scripts, validation, credentials, webhook IDs, activation, execution, repo/live sync, and workflow templates.
