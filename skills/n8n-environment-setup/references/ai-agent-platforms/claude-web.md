...
- Use `skills/n8n-environment-setup/references/n8n/local-setup.md` for the full local n8n setup guide.
- Use `skills/n8n-environment-setup/references/ai-agent-platforms/claude-code.md` for Claude Code skills-first routing.
- Use `skills/n8n-environment-setup/SKILL.md` as the environment router.
