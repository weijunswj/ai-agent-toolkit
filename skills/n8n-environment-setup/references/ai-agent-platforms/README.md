...
These platform references route each AI platform to this toolkit. Generic rules live in [Repository Agent Rules](../../../repository-agent-rules/); full n8n rules live in [n8n Safety Router](../../../n8n-safety-router/).
