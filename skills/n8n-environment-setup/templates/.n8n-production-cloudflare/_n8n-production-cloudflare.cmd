...
pushd "%STACK_DIR%" >nul
if errorlevel 1 (
  echo Failed to open n8n production Cloudflare stack folder: %STACK_DIR%
  pause
  exit /b 1
)
...
:unexpected_failure
echo.
echo The n8n production Cloudflare menu stopped unexpectedly with exit code %EXIT_CODE%.
