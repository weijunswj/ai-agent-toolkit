...
Load [n8n Safety Router](../n8n-safety-router/) before n8n workflow, import/export, credential, execution, repo/live sync, or live-instance work. A generated cross-skill copy is available at [references/n8n-safety-rules.md](references/n8n-safety-rules.md).
