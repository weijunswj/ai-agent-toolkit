---
name: n8n-workflow-transport
description: Prepare n8n workflow files safely through offline sanitisation, validation, comparison, and manual import/export preparation. Apply n8n-safety-router first. This product does not grant live n8n authority or implement API-first live transport.
---
...
Apply `n8n-safety-router` first for the full n8n operating contract. A generated local copy is available at [references/n8n-safety-rules.md](references/n8n-safety-rules.md) for portability.
...
- The user asks only to inspect test-only workflow fixtures; fixtures are not installable products.
...
- Follow `n8n-safety-router` for [official n8n Skills](https://github.com/n8n-io/skills), their entry-point meta-skill currently named `using-n8n-skills`, workflow JSON, official n8n MCP, `n8n_live`, import/export, validation, credentials, webhook IDs, activation, execution, repo/live sync, and live n8n safety.
...
- `references/n8n-safety-rules.md`: generated cross-skill copy of the full n8n operating rules.
