...
Source: _projects/cicd/repository-security-gate/curated_output_for_ai/packs/repository-security-gate/README.md
Update the curated output and run sync.
-->
# Repository Security Gate Pack

Review and copy the entire `skills/repository-security-gate/` folder. Pin pack
version `1.0.0` in the consumer repository. The pack contains no scanner binary
