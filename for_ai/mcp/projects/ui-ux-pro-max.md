...
- Instruction-only skill: [for_ai/skills/design/ui-ux-secure-frontend-design/](../../skills/design/ui-ux-secure-frontend-design/)
- Optional local tool: [for_ai/tools/design-system-generator/](../../tools/design-system-generator/)
...
- Optional generator output only under `for_ai/tools/design-system-generator/output/**` when explicitly requested.
